...
static const unsigned char PULSE_LOGO_DATA[PULSE_LOGO_LEN] = {
    ...
    
};
...
static void ib_install_systemd_boot(IB *ib, const char *root_dev) {
    ...
    {
        char tmp_kl[512] = {0};
        if (strstr(st.kernel_list,"linux") && strstr(st.kernel_list,"linux-lts")) {
            strcat(tmp_kl, "linux");
            char scan[512]; strncpy(scan, st.kernel_list, sizeof(scan)-1);
            char *t2 = strtok(scan, " ");
            while (t2) {
                if (strcmp(t2,"linux") != 0) {
                    strcat(tmp_kl, " ");
                    strcat(tmp_kl, t2);
                }
                t2 = strtok(NULL, " ");
            }
            strncpy(st.kernel_list, tmp_kl, sizeof(st.kernel_list)-1);
        }
    }
...

    {
        ...
        if (flsb) {
            fprintf(flsb,
                ...
                "DISTRIB_DESCRIPTION=\"PulseOS\"\n");
            fclose(flsb);
        }

        FILE *fiss = fopen("/mnt/etc/issue", "w");
        if (fiss) {
            fprintf(fiss, "Welcome to PulseOS  \\r  (\\l)\n\n");
            fclose(fiss);
        }

        FILE *fmotd = fopen("/mnt/etc/motd", "w");
        if (fmotd) {
            fprintf(fmotd, "Welcome to PulseOS\n");
            fclose(fmotd);
        }
